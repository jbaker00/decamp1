...
- (NSString *)getBusScheduleFileName:(NSString *)strBusNumber {
    ...
    if([_btnFrom.titleLabel.text isEqualToString:@"NYC P/A Bus Terminal"])
    {
...
- (NSString*)fillTableHeader:(NSString *)strBusNumber {
    ...
    [stringTitle appendString:_btnFrom.titleLabel.text];
    [stringTitle appendString:@" to "];
    [stringTitle appendString:_btnTo.titleLabel.text];
